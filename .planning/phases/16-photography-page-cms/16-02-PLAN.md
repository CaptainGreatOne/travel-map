...
wave: 1
depends_on: []
files_modified: [src/components/admin/PhotoManager.jsx, src/pages/AdminPage.jsx]
autonomous: true
---

<objective>
Create admin UI for photo management with upload, reorder, and delete functionality.

Purpose: Enable admin to manage Photography page content.
Output: PhotoManager component integrated into AdminPage with Photos tab.
</objective>
...
<task type="auto">
  <name>Task 1: Create PhotoManager component</name>
  <files>src/components/admin/PhotoManager.jsx</files>
  <action>
Create PhotoManager following existing admin component patterns (LocationManager, VideoManager):
...
- Two-click delete confirmation (consistent with other admin components)
...
- Loading state
  ...
  <done>PhotoManager component created with upload, reorder, delete functionality</done>
</task>

<task type="auto">
  <name>Task 2: Add Photos tab to AdminPage</name>
  <files>src/pages/AdminPage.jsx</files>
  <action>
1. Import PhotoManager:
   ```jsx
   import PhotoManager from '../components/admin/PhotoManager';
   ```

2. Add 'photos' to tabs array:
   ```jsx
   const tabs = [
...
3. Add Photos tab content after Videos tab:
   ```jsx
   {/* Photos Tab */}
   {activeTab === 'photos' && <PhotoManager />}
   ```
  </action>
  <verify>npm run build succeeds, Photos tab appears in admin navigation</verify>
  <done>Photos tab added to AdminPage with PhotoManager component</done>
</task>
...
- [ ] `npm run lint` passes
- [ ] PhotoManager component exists with upload, reorder, delete
- [ ] AdminPage has Photos tab in navigation
</verification>

<success_criteria>
- All tasks completed
- PhotoManager follows existing admin component patterns
- Photos tab integrated into AdminPage
</success_criteria>

<output>
After completion, create `.planning/phases/16-photography-page-cms/16-02-SUMMARY.md`
</output>
